                    ...
                    <div class="in-blog-1" data-uk-grid>
                            ...
                            <article class="uk-card uk-card-default uk-border-rounded">
                                ...
                                <div class="uk-card-footer uk-clearfix">
                                    <div class="uk-float-left">
                                        <span class="uk-label in-label-small">Investing</span>
                                    </div>
                                    <div class="uk-float-right">
                                        <a href="blog/the-typical-us-household-is-spending-445-more-a.html" class="uk-button uk-button-text">Read more</a>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="in-stretch">
                            <article class="uk-card uk-card-default uk-border-rounded">
                                ...
                                <div class="uk-card-footer uk-clearfix">
                                    <div class="uk-float-left">
                                        <span class="uk-label in-label-small">Politics</span>
                                    </div>
                                    <div class="uk-float-right">
                                        <a href="blog/biden-and-harris-celebrate-kwanzaa-in-social-media.html" class="uk-button uk-button-text">Read more</a>
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="in-stretch">
                            <article class="uk-card uk-card-default uk-border-rounded">
                                ...
                                <div class="uk-card-footer uk-clearfix">
                                    <div class="uk-float-left">
                                        <span class="uk-label in-label-small">Technology</span>
                                    </div>
                                    <div class="uk-float-right">
                                        <a href="blog/amazons-started-to-deliver-orders-by-drones-in-california.html" class="uk-button uk-button-text">Read more</a>
                                    </div>
                                </div>
                            </article>
                        </div>
