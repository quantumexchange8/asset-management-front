        ...
        <div class="uk-container">
            <div class="uk-grid" data-uk-grid>
                <div class="uk-width-1">
                    <h1 class="uk-margin-remove"><span class="in-highlight">Merge Signal Strategy</span></h1>
                    <p class="uk-text-lead uk-text-muted">Our most successful portfolio, which includes the Dynamic Gold system and the Pulsar reversion method. Our fund manager will use macro data to establish the proportions of different strategies. This portfolio is appropriate for retail and professional investors with personal fund sizes under USD250K.</p>            
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="uk-width-1-5@m uk-text-right@m">
                                    <a href="#" class="uk-button uk-button-text uk-text-muted">Enter Course<i class="fas fa-chevron-right fa-xs uk-margin-small-left"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td class="uk-width-1-3@m">
