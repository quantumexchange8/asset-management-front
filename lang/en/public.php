...
return [
    ...
    'ceo-message-2' => 'There are numerous forex service providers worldwide. Each year, XXX witnesses many leaving the market while new providers join. XXX has managed to survive and grow in this competitive market not only by offering professional services but also by supporting systematic trading strategies. Strategy support is our core competitive advantage. In 2017, XXXX transitioned from being a forex service provider to a strategy provider. The financial market encompasses many arbitrage strategies. PNK continuously conducts research and practical applications to build professional mathematical models and databases. When a trading strategy becomes widely used, its profit potential diminishes. XXX can quickly retrieve new trading strategies from its database, ensuring its leading edge and consistently delivering profits to users.',
    'ceo-message-3' => 'After achieving success in hedge arbitrage, we introduced a new strategy—neutral arbitrage—in 2020, which we believe will yield even greater gains. XXX has always been growing and actively maintaining its competitive edge. Within the next five years, PNK plans to establish PXX International Investment Bank. XXX looks forward to sharing the dividends of growth with global investor',
    ...
    'approach-title' => 'XXXX, how the trading team makes money by standing on the shoulders of giants',
    'approach-desc' => 'In arbitrage trading, markets are ever-changing, and no strategy works universally. If a model fails, investors must quickly adapt, either by adjusting the model or abandoning the strategy altogether. XXXX continuously tests, evaluates, and applies data models to pursue predictive accuracy and profitability. This systematic approach involves:',
